...
export interface IYoTeamsTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface IYoTeamsTabRemoveProps {

}

/**
 * Implementation of yo teams tab remove page
 */
export class YoTeamsTabRemove  extends TeamsBaseComponent<IYoTeamsTabRemoveProps, IYoTeamsTabRemoveState> {
