...
export interface IYoTeamsTabConfigState extends ITeamsBaseComponentState {
    value: string;
}

export interface IYoTeamsTabConfigProps {

}

/**
 * Implementation of yo teams tab configuration page
 */
export class YoTeamsTabConfig  extends TeamsBaseComponent<IYoTeamsTabConfigProps, IYoTeamsTabConfigState> {
        ...
        if (await this.inTeams()) {
            ...
            microsoftTeams.settings.registerOnSaveHandler((saveEvent: microsoftTeams.settings.SaveEvent) => {
                ...
                microsoftTeams.settings.setSettings({
                    ...
                    suggestedDisplayName: "yo teams tab",
